...
class InfoDrop(Attack):
    ...
    """
    def __init__(self, model, height = 224, width = 224,  steps=50, batch_size = 20, block_size = 8, q_size = 100, targeted = False):
...
if __name__ == "__main__":
    ...
    cur_cnt = 0
    suc_cnt = 0
    data_dir = "/root/data1/code/test-data6"
    data_clean(data_dir)
    ...
    for i in range(tar_cnt//batch_size):
        ...
        images = images * 255.0
        attack = InfoDrop(resnet_model, batch_size=batch_size, q_size =q_size, steps=50, targeted = False)    
